...
established against `@actual-app/api` 26.9.0. Upstream can turn a throwing path into a
...
The table was first built against 26.8.0 and then re-verified mechanically against 26.9.0
...
| Method | Documented | Actually returns at 26.9.0 |
|---|---|---|
...
| Tool | Upstream call | Shape | Evidence at 26.9.0 | Ticket |
|---|---|---|---|---|
